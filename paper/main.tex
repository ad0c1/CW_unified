...
1{,}000 replicates; axis labels give each arm's scoring formula. Each
point is one replicate (horizontal jitter only), violins show the
boundary-corrected density, and white dots mark medians. The Gini
...
Section~\ref{sec:wedge}. The right-hand distributions pile at ceiling
(73--74\% of replicates at AUROC exactly $1.00$, annotated), which is
why their densities compress into the solid band at the top. The oracle subgroup comparator (mean AUROC
